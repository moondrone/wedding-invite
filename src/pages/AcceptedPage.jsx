    ...
    return (
        <div className="min-h-screen bg-white text-center p-6">
            ...
            <div className="bg-pink-100 rounded-lg shadow p-4 max-w-xl mx-auto">
                ...
                <li>Цветы, пожалуй, можно оставить для других случаев - пусть этот день будет наполнен только вашими улыбками и хорошими словами</li>
                <li>На нашем празднике, к сожалению, не предусмотрена детская программа.<br/>
                   Если возможно - позвольте себе этот вечер без самых маленьких гостей. Пусть он станет уютным праздником и для Вас! </li>

                <h2 className="text-xl font-semibold mt-4 mb-2">📝 Вопросы?</h2>
                <p>Звоните</p>
                <p>Евгений 5667 0265</p>
                <p>Оксана 5804 2412</p>
            </div>
        </div>
    )
}
